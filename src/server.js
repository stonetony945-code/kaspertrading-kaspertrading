...
- data_get_derived_indicators → Stochastic, ATR, Fair Value Gaps, volume profile computed FROM the bars.
  Costs no indicator slot, so it works when the chart is at TradingView Basic's 2-indicator limit or the
  indicator simply isn't loaded. Use the include parameter to request only what you need.
